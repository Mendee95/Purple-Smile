...
export default function LandingPage() {
  ...
  const products = [
    ...
    {
      id: 'pro', name: 'Про багц', strips: '14 Судал',
      photo: '/photos/product-pro.jpg',
      desc: 'Хамгийн өндөр үр дүн. 14 хоногийн мэргэжлийн түвшний цайруулга.',
      features: ['2 багц — 14 цайруулах судал', '14 хоногийн эмчилгээний төлөвлөгөө', 'PAP+ Дэвшилтэт томъёо', 'Үнэгүй хүргэлт'],
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-6">
              {/* Stat cards */}
              {[
                { label: '30 МИН', sub: 'Application per use' },
                { label: '3 ӨДӨР', sub: 'Анхны үр дүн гарна' },
                { label: '8 ШАТ', sub: 'Хамгийн их цайралт' },
              ].map(s => (
