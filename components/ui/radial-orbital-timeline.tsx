...
export default function RadialOrbitalTimeline({
  ...
  // suppress unused-state-setter lint warnings — setters kept for future use
  void setViewMode;
  ...
  const getStatusLabel = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "in-progress": return "ЯВАГДАЖ БАЙ";
      case "pending":     return "ДАРААЧИЙН";
      default:            return "ДАРААЧИЙН";
    }
  };
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* ── Centre orb — Purple Smile brand gradient ── */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-purple-800 via-violet-500 to-pink-400 animate-pulse flex items-center justify-center z-10">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-pink-400 to-violet-700"
